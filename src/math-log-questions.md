...
* **Псевдобулева алгебра (алгебра Гейтинга).** Импликативная решетка с 0
  ...
  * 0 - наименьший элемент решетки
  ...
  Поскольку в принятом нами интуиционистком исчислении высказываний доказываются не высказывания, а некоторое сложные условные выражения (записи вида $\Gamma\vdash\alpha$), то и оценкойддля данных выражений мы выберем неравенство. А именно, если $\Gamma=\{\gamma_1,...\gamma_n\},g_i=[\gamma_i]\ и\ a=[\alpha]$, то выражению $\Gamma\vdash\alpha$ сопоставим неравенство: $g_1\ast g_2\ast...\ast g_n\sqsubseteq a$.
  ...
  Разберем все логические связки и представим их как
  </details>
